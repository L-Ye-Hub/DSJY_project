<%@ Page Title="" Language="C#" MasterPageFile="~/Admins/Shared/Backend.Master" AutoEventWireup="true" CodeBehind="Seos_Edit.aspx.cs" Inherits="WebApp.Admins.Seos.Seos_Edit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>编辑Seo优化信息</title>
</asp:Content>
        ...
        <div class="col-md-offset-1 col-md-10">
            <div class="panel">
                <div class="panel-heading">
                    <h3 class="panel-title">编辑优化信息</h3>
                </div>
                <div class="panel-body">
                    <asp:HiddenField ID="hfSeosId" runat="server" />
