<%@ Page Title="" Language="C#" MasterPageFile="~/Admins/Shared/Backend.Master" AutoEventWireup="true" CodeBehind="SystemMenu_List.aspx.cs" Inherits="WebApp.Admins.SystemMenu.SystemMenu_List" %>
                        ...
                        <asp:Repeater ID="RepSystemMenusList" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-danger" href='SystemMenu_Delete.aspx?action=<%#Eval("SystemMenus_Id") %>'>
