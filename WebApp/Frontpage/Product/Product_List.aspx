<%@ Page Title="" Language="C#" MasterPageFile="~/Admins/Shared/Backend.Master" AutoEventWireup="true" CodeBehind="Product_List.aspx.cs" Inherits="WebApp.Frontpage.Product.Product_List" %>
    ...
    <div class="row mb-1">
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="col-md-4">
                ...
                <a href="Product_Add.aspx" class="btn btn-success">Insert</a>
                            ...
                            <asp:Repeater ID="RepUsersList" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <img src='../../upload/Product/<%#Eval("Product_Image ") %>' style="width: 100px; height: 100px;" />
                                        </td>
                                        <td>
                                            <%#Eval("Product_Intro") %>
                                        </td>
                                        <td>
                                            <%#Eval("Product_Content") %>
                                        </td>
                                        <td>
                                            <%#Eval("Product_Price") %>
                                        </td>
                                        <td>
                                            <a class="btn btn-warning" href='Product_Edit.aspx?action=<%#Eval("Product_Id") %>'>
                                                <span class="lnr lnr-pencil"></span>修改
                                        </a>
                                        </td>
                                        <td>
                                            <a class="btn btn-danger" href='Product_Remove.aspx?action=<%#Eval("Product_Id") %>'>
