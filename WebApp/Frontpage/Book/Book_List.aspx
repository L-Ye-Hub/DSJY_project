<%@ Page Title="" Language="C#" MasterPageFile="~/Admins/Shared/Backend.Master" AutoEventWireup="true" CodeBehind="Book_List.aspx.cs" Inherits="WebApp.Frontpage.Book.Book_List" %>
    ...
    <div class="row mb-1">
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="col-md-4">
                ...
                <a href="Book_Add.aspx" class="btn btn-success">Insert</a>
                            ...
                            <asp:Repeater ID="RepUsersList" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <img src='../../upload/Book/<%#Eval("Book_Image ") %>' style="width: 100px; height: 100px;" />
                                        </td>
                                        <td>
                                            <%#Eval("Book_Price") %>
                                        </td>
                                        ...
                                        <td>
                                            <a class="btn btn-warning" href='Book_Edit.aspx?action=<%#Eval("Book_Id") %>'>
                                                <span class="lnr lnr-pencil"></span>修改
                                        </a>
                                        </td>
                                        <td>
                                            <a class="btn btn-danger" href='Book_Remove.aspx?action=<%#Eval("Book_Id") %>'>
