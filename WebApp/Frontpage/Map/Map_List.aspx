<%@ Page Title="" Language="C#" MasterPageFile="~/Admins/Shared/Backend.Master" AutoEventWireup="true" CodeBehind="Map_List.aspx.cs" Inherits="WebApp.Frontpage.Map.Map_List" %>
     ...
     <div class="row mb-1">
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="col-md-4">
                ...
                <a href="Map_Add.aspx" class="btn btn-success">Insert</a>
                            ...
                            <asp:Repeater ID="RepUsersList" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-warning" href='Map_Edit.aspx?action=<%#Eval("Map_Id") %>'>
                                                <span class="lnr lnr-pencil"></span>修改
                                        </a>
                                        </td>
                                        <td>
                                            <a class="btn btn-danger" href='Map_Remove.aspx?action=<%#Eval("Map_Id") %>'>
