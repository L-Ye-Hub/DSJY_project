<%@ Page Title="" Language="C#" MasterPageFile="~/Admins/Shared/Backend.Master" AutoEventWireup="true" CodeBehind="Send_List.aspx.cs" Inherits="WebApp.Frontpage.Send.Send_List" %>
       ...
       <div class="row mb-1">
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="col-md-4">
                ...
                <a href="Send_Add.aspx" class="btn btn-success">Insert</a>
                            ...
                            <asp:Repeater ID="RepUsersList" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <img src='../../upload/Send/<%#Eval("Send_Image ") %>' style="width: 100px; height: 100px;" />
                                        </td>
                                        <td>
                                            <%#Eval("Send_Content") %>
                                        </td>
                                        ...
                                        <td>
                                            <a class="btn btn-warning" href='Send_Edit.aspx?action=<%#Eval("Send_Id") %>'>
                                                <span class="lnr lnr-pencil"></span>修改
                                        </a>
                                        </td>
                                        <td>
                                            <a class="btn btn-danger" href='Send_Remove.aspx?action=<%#Eval("Send_Id") %>'>
