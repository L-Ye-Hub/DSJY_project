<%@ Page Title="" Language="C#" MasterPageFile="~/Frontpage/Shared/FrontShared.Master" AutoEventWireup="true" CodeBehind="guanyu1.aspx.cs" Inherits="WebApp.Frontpage.guanyu1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="xia">
        ...
        <asp:Repeater ID="RepIntroList" runat="server">
            <ItemTemplate>
                <div class="xia_2s">
                    <div class="xia_2as">
                        <a href="#">
                            <img src='../../upload/Intro/<%#Eval("Intro_Image") %>' />
                    </div>
                    <div class="xia_2a_1">
                        <%#Eval("Intro_Content") %>
                    </div>
